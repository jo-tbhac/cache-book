...
export const FormPresenter: FC<FormPresenterProps> = ({
  ...
  const handleChangeSubscriptionTitle = (text: string) => {
    setSubscriptionTitle(text)
  }

  const handleChangeSubscriptionValue = (text: string) => {
    setSubscriptionValue(text)
  }
    ...
    >
      <View style={styles.sectionContainer}>
        ...
        <TextInput
          ...
          onChangeText={handleChangeSubscriptionTitle}
      ...
      <View style={styles.sectionContainer}>
        ...
        <TextInput
          ...
          onChangeText={handleChangeSubscriptionValue}
          style={styles.textInput}
          selectionColor={theme.colors.app.primary.main}
      ...
      <View style={styles.buttonContainer}>
        <Button style={styles.button} onPress={handleSaveSubscription}>
          保存
        </Button>
      </View>
    </ScrollView>
