...
import { SubscriptionListItemPresenterProps } from './types'

export const SubscriptionListItemPresenter: FC<SubscriptionListItemPresenterProps> = ({
  subscription,
  category,
  navigateEditSubscriptionPage,
  ...
  return (
    <>
      <ListItem
        ...
        onPress={navigateEditSubscriptionPage}
      ...
      >
        ...
        <View style={styles.value}>
          <Text style={styles.valueText}>{subscription.value.toLocaleString('ja-jp')}</Text>
        </View>
